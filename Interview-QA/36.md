...
```mermaid
flowchart LR
A[Endpoint Telemetry<br>(Process, Command Line)] --> E[Unified Timeline]
B[Authentication Logs<br>(Logins, MFA)] --> E
C[Network Logs<br>(C2, Lateral Movement)] --> E
D[System Logs<br>(Event Logs, Services)] --> E
