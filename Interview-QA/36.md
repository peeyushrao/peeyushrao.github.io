...
```mermaid
flowchart LR
A[Endpoint Telemetry (Process, Command Line)] --> E[Unified Timeline]
B[Authentication Logs (Logins, MFA)] --> E
C[Network Logs (C2, Lateral Movement)] --> E
D[System Logs (Event Logs, Services)] --> E
